...
lvim.keys.normal_mode["<leader>st"] = ":Telescope live_grep_args<CR>"
...
lvim.plugins = {
  ...
  { "tiagovla/scope.nvim" },
  { 'ruifm/gitlinker.nvim' }, -- replaces rhubarb
}
...
vim.g['test#javascript#jest#executable'] = 'dox-do ./node_modules/.bin/jest'
